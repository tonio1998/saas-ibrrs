...
<div class="content">
    ...
    <p class="indent">
        ...
        <span class="bold">
            {{ strtoupper($cert->resident->FirstName) }} {{ strtoupper($cert->resident->LastName) }}
        </span>,
        of legal age, Filipino, is a bona fide resident of Barangay
    ...
    <p class="indent">
        This further certifies that the above-named person has been residing in this barangay for
        <span class="bold">
            {{ $cert->resident->years_of_residency ?? '_____'}} years
        </span>.
    </p>
