...
<div class="title">
    CERTIFICATION (FIRST TIME JOB SEEKER)
</div>
...
<div class="content">
    ...
    <p class="indent">
        ...
        <span class="bold">{{ strtoupper($cert->resident->FirstName) }} {{ strtoupper($cert->resident->LastName) }}</span>,
    ...
    <p class="indent">
        This is to further certify that the above-named individual is a
        <span class="bold">FIRST TIME JOB SEEKER</span> as defined under Republic Act No. 11261,
