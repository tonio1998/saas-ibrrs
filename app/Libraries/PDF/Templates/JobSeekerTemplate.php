...
class JobSeekerTemplate implements TemplateInterface
{
    ...
    public function render($pdf, $cert): void
    {
        ...
        $this->styledHeaderText($pdf, "FIRST TIME JOB SEEKER CERTIFICATE", $contentWidth);
        ...
        $text2 =
            "Further, this is to certify that the above-named person is a qualified First-Time Job Seeker pursuant to Republic Act No. 11261, otherwise known as the First Time Jobseekers Assistance Act.\n\n" .
            "This certification is issued to avail the benefits provided under the said Act.\n\n" .
