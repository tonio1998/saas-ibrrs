...
class IndigencyTemplate implements TemplateInterface
{
    ...
    public function render($pdf, $cert): void
    {
        ...
        $this->styledHeaderText($pdf, "CERTIFICATE OF INDIGENCY", $contentWidth);
        ...
        $text2 =
            "Further, this is to certify that the above-named person belongs to an indigent family and has no sufficient source of income to support daily subsistence, as verified by this office.\n\n" .
            "This certification is being issued upon the request of the concerned individual for whatever legal purpose it may serve.\n\n" .
        ...
        $pdf->Cell($contentWidth, 6, 'Certified by:', 0, 1, 'R');
